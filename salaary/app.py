...
model = pickle.load(open(r'Z:\vs\salaary\linear_regression_model.plk', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Anudhan Boss!")